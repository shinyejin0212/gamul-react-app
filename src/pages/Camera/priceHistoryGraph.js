...
function PriceHistoryGraph() {
  ...
  console.log(pricesHistories[0].length);
  var labels = [];
    ...
    if (arr_data.length === 1) {
      data = {
        ...
        datasets: [
          {
            label:
              pricesHistories[0][0].name + "/" + pricesHistories[0][0].unit,
            data: arr_data[0],
      ...
      data = {
        ...
        datasets: [
          ...
          {
            label:
              pricesHistories[0][1].name + "/" + pricesHistories[0][1].unit,
            data: arr_data[1],
            borderColor: "#FCDDB0",
      ...
      data = {
        ...
        datasets: [
          ...
          {
            label:
              pricesHistories[0][2].name + "/" + pricesHistories[0][2].unit,
            data: arr_data[2],
            borderColor: "#FF9F9F",
      ...
      data = {
        ...
        datasets: [
          ...
          {
            label:
              pricesHistories[0][3].name + "/" + pricesHistories[0][3].unit,
            data: arr_data[3],
            borderColor: "#E97777",
